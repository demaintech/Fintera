...
const page = () => {
  return (
    <div className="space-y-4 sm:space-y-6">
      <section className="rounded-2xl sm:rounded-3xl border border-gray-500 bg-linear-to-br from-primary/10 via-background to-background p-4 sm:p-6 shadow-sm">
      ...
      <section className="grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
        {metrics.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="rounded-lg sm:rounded-2xl border  border-gray-500 dark:border-border-gray-900 bg-background p-3 sm:p-5 shadow-sm transition hover:-translate-y-0.5"
            >
      ...
      <section className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl sm:rounded-3xl border border-gray-500 bg-background p-4 sm:p-6 shadow-sm">
          ...
          <ul className="mt-3 sm:mt-5 space-y-2 sm:space-y-3 text-xs sm:text-sm text-foreground/70">
            <li className="rounded-lg sm:rounded-xl border border-gray-500 bg-muted/30 px-3 sm:px-4 py-2 sm:py-3">Feed delivery scheduled for tomorrow</li>
            <li className="rounded-lg sm:rounded-xl border border-gray-500 bg-muted/30 px-3 sm:px-4 py-2 sm:py-3">Water quality check due in 2 hours</li>
            <li className="rounded-lg sm:rounded-xl border border-gray-500 bg-muted/30 px-3 sm:px-4 py-2 sm:py-3">Harvest planning review at 4 PM</li>
          </ul>
        </div>
